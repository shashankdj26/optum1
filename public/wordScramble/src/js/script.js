...
wordDictionay = [
  ...
  {
    question: "This is one of UnitedHealth Group/ Optum’s value",
    key: shuffle("RELATIONSHIPS"),
    value: "RELATIONSHIPS",
    Hint: "RELATIONSHIPS",
  },
  {
    question: "One Optum’s office location in APAC region",
    key: shuffle("TAGUIG"),
    value: "TAGUIG",
    Hint: "TAGUIG",
  },
  ...
  {
    question: "This is the headquarters of UnitedHealth Group",
    key: shuffle("MINNESOTA"),
    value: "MINNESOTA",
    Hint: "MINNESOTA",
  },
  ...
  {
    question: "Name of one of the finalist’s teams",
    key: shuffle("PHOENIX"),
    value: "PHOENIX",
    Hint: "PHOENIX",
  },
  {
    question:
      "This college was the business round winner of Optum Stratethon Season 1",
    key: shuffle("SYMBIOSIS"),
    value: "SYMBIOSIS",
    Hint: "SYMBIOSIS",
  },
  {
    question: "This is global Optum site with highest headcount in India",
    key: shuffle("HYDERABAD"),
    value: "HYDERABAD",
    Hint: "HYDERABAD",
  },
  ...
  {
    question: "We invest 3.3 billion in technology and",
    key: shuffle("INNOVATION"),
    value: "INNOVATION",
    Hint: "INNOVATION",
  },
];
...
function disableBtn() {
  ...
  document
    ...
    .setAttribute("class", "puzzle-next disablecharacter");
...
function disablebackBtn() {
  if (backenable) {
    ...
    document
      ...
      .setAttribute("class", "puzzle-back disablecharacter");
  }
}
...
function drawLabel(cha, count, input) {
  ...
  if (spacecontaning) {
    if (cha != " ")
      $("#puzzleword2").append(
        "<input type='button' class='puzzle-char' id='" +
          cha +
          input +
          "' onmousedown= 'charOnClick(this.value,this.id);' value ='" +
          cha +
          "'></input>"
      );
  } else {
...
function charOnClick(chrs, id) {
  if (!enablenextbtn) {
    ...
    document
      .getElementById(id)
      .setAttribute("class", "puzzle-char hidecharacter");
...
function clickOnBackBTN() {
  document
    .getElementById(clickedcharacter[clickedcharacter.length - 1].id)
    .setAttribute("class", "puzzle-char");
  document.getElementById(
    clickedcharacter[clickedcharacter.length - 1].id
  ).disabled = false;
...
function showrightanswer() {
  document.getElementById("answer").innerHTML =
    wordDictionay[currentindex - 1].Hint;
...
function changecolorAccordingtoResult(colorcode) {
  ...
  enableBtn();
  if (colorcode == 1)
    document.getElementById("puzzlesolution").style.backgroundColor =
      "rgb(57,181,74)";
  else {
    document.getElementById("puzzlesolution").style.backgroundColor =
      "rgb(239,28,37)";
