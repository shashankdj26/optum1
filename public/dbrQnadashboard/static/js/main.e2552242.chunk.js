    ...
    24: function (e, t, a) {
      ...
      class d extends o.a.Component {
        ...
        render() {
          ...
          // }, "Audi Poll Session")), " ", o.a.createElement("p", null, o.a.createElement("a", {
          // 	href: "/dbrPolldashboard/index.html"
          // }, "DBR Poll Session")), " ", o.a.createElement("p", null, o.a.createElement("a", {
          // 	href: "/qnadashboard/index.html"
          // }, "AUDI Q&A")), " ", o.a.createElement("p", null, o.a.createElement("a", {
          // 	href: "/dbrQnadashboard/index.html"
          // }, "DBR Q&A")), " ", o.a.createElement("button", {
          // 	onClick: this.logout
          // }, "Logout")))
          return null;
        }
      ...
      const A = () => {
          ...
          function s(e) {
            i((t) =>
              t.filter((t, a) => {
                a === e &&
                  l.firestore().collection("qna-dbr").doc(t.id).delete();
              })
            );
          }
          ...
          function r(e) {
            ...
            i((a) =>
              a.filter((a, n) => {
                n === e &&
                  l.firestore().collection("qna-dbr").doc(a.id).update({
                    time: new Date(),
                    time2: t,
                    status: "1",
                  });
          ...
          function c(e) {
            i((t) =>
              t.filter((t, a) => {
                a === e &&
                  l.firestore().collection("qna-dbr").doc(t.id).update({
                    time: new Date(),
                    time2: b,
                    status: "2",
                  });
