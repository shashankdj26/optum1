...
zoomlink.addEventListener("focus", () => {
  updated.style.display = "none";
  error.style.display = "none";
  updatedlink.style.display = "none";
  linkerror.style.display = "none";
...
const validateData = (agenda, show, message, time, timer, zoomlink) => {
  if (message.value === "") {
    return false;
  }
  if (time.value === "") {
...
document.getElementById("update").addEventListener("mouseup", () => {
  ...
  //   const canContinue = validateData(agenda, show, message, time, timer,zoomlink);
  ...
  if (canContinue) {
    ...
    app
      ...
      .update({
        ...
        link: zoomlink.value === "" ? data.zoomlink : zoomlink.value,
      })
      .then(() => {
        getData().then((res) => {
          data = res;
